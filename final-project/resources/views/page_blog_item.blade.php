			...
			<div class="top-menu">
				<ul class="nav navbar-nav pull-right">
							...
							<li>
								<ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
									<li>
										...
										<span class="photo">
										<img src="/css/admin/layout3/img/avatar2.jpg" class="img-circle" alt="">
										</span>
										<span class="subject">
										<span class="from">
										Lisa Wong </span>
									...
									<li>
										<a href="inbox.html?a=view">
										<span class="photo">
										<img src="/css/admin/layout3/img/avatar3.jpg" class="img-circle" alt="">
										</span>
										<span class="subject">
										<span class="from">
										Richard Doe </span>
									...
									<li>
										<a href="inbox.html?a=view">
										<span class="photo">
										<img src="/css/admin/layout3/img/avatar1.jpg" class="img-circle" alt="">
										</span>
										<span class="subject">
										<span class="from">
										Bob Nilson </span>
					...
					<li class="dropdown dropdown-user dropdown-dark">
						<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
						<img alt="" class="img-circle" src="/css/admin/layout3/img/avatar9.jpg">
							...
							<div class="row">
								...
								<div class="col-md-3 blog-sidebar">
									...
									<ul class="list-inline blog-images">
										<li>
											<a class="fancybox-button" data-rel="fancybox-button" title="390 x 220 - keenthemes.com" href="/css/admin/pages/media/blog/1.jpg">
											<img alt="" src="/css/admin/pages/media/blog/1.jpg">
											</a>
										</li>
										<li>
											<a href="javascript:;">
											<img alt="" src="/css/admin/pages/media/blog/2.jpg">
											</a>
										</li>
										<li>
											<a href="javascript:;">
											<img alt="" src="/css/admin/pages/media/blog/3.jpg">
											</a>
										</li>
										<li>
											<a href="javascript:;">
											<img alt="" src="/css/admin/pages/media/blog/4.jpg">
											</a>
										</li>
										<li>
											<a href="javascript:;">
											<img alt="" src="/css/admin/pages/media/blog/5.jpg">
											</a>
										</li>
										<li>
											<a href="javascript:;">
											<img alt="" src="/css/admin/pages/media/blog/6.jpg">
											</a>
										</li>
										<li>
											<a href="javascript:;">
											<img alt="" src="/css/admin/pages/media/blog/8.jpg">
											</a>
										</li>
										<li>
											<a href="javascript:;">
											<img alt="" src="/css/admin/pages/media/blog/10.jpg">
											</a>
										</li>
										<li>
											<a href="javascript:;">
											<img alt="" src="/css/admin/pages/media/blog/11.jpg">
											</a>
										</li>
										<li>
											<a href="javascript:;">
										...
										<li>
											<a href="javascript:;">
											<img alt="" src="/css/admin/pages/media/blog/7.jpg">
											</a>
										</li>
									</ul>
									<div class="space20">
